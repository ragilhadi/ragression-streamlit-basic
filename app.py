...
area_input = st.number_input('Insert Area of the House :house:')
bedroom_input = st.number_input('Insert How many bedrooms in the House :bed:')
age_input = st.number_input('Insert Age of the House :1234:')
